...
# Logging stream : used for logging messages whenever we create files using this template file
logging.basicConfig(level = logging.INFO , format = '[%(asctime)s]: %(message)s:') #logging.Info - basic information logging. Format specifies format of logging
