...
def save_json(path:Path, data:dict):
    ...
    Args:
        ...
        data (dict): ndata to be saved in json file
    """
...
@ensure_annotations
def save_bin(data: Any, path: Path):  #can hold value of any type
    """ save binary file
    Args:
        data (Any): data to be saved as binary file
        path (Path): path to binary file
    """
    joblib.dump(value=data, filename=path) #joblib : store large numpt arrays more efficiently
